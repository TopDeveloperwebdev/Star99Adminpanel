...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body" id="cardCreateNumbers"
             style="padding-top:0%; padding-left:20%; padding-right:20%; padding-bottom:5%;">
            ...
            <div id="table" class="table-editable table-responsive">
                <table class="table table-bordered table-striped text-center"
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" colspan="3" class="edittd" id="number_<?php echo $i;?>"
                            required></td>
                    </tr>
                    <?php }?>
                    </tbody>
                ...
                <div class="text-center">
                    <button id="saveNumbers" class="btn btn-primary" style="font-size:20px;"><i
                                class="far fa-file-alt"></i>Create
                    </button>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            $("#saveNumbers").click(function () {
                ...
                if (wrongnumbers == true) {
                    ...
                    $.post('allowCreateVideo', {_token: '{{csrf_token()}}'}, function (data) {
                        if (data.status == "1") {
                            $.post('createNewNumbers', {values, _token: '{{csrf_token()}}'}, function (data) {
                                ...
                                $.get('http://95.217.73.101/?video=fhvht7r2v873783&itr=181', function () {
                                    window.location.href = 'dashboard';
                                });
                            });
                        } else {
                            alert("Video creation in process, wait for " + Math.round(data.diff)+" minutes.");
                        }
                    });
                }
            });
